  ...
  return (
    ...
    >
      <div className="text-center">
        ...
        Foodies Den : Smart Table Reservations with Kimi AI 
        </h1>
        <p className="mt-6 text-xl text-gray-500 max-w-3xl mx-auto">
          Book your perfect dining experience with our intelligent reservation system.
          No more waiting, no more confusion - just seamless bookings.
        </p>
        <div className="mt-10">
          <Link
            to="/book"
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
          <div className="relative bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="mt-2 text-gray-500">
              Our AI suggests the perfect table based on your party size and preferences.
            </p>
          </div>
          ...
          <div className="relative bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="mt-2 text-gray-500">
              See available time slots instantly and book without waiting.
            </p>
          </div>
          ...
          <div className="relative bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="mt-2 text-gray-500">
              Manage your reservations effortlessly with our intuitive dashboard.
            </p>
          </div>
        </div>
      </div>
